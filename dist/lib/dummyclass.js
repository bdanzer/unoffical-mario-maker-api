...
const debug = chalk_1.default.red;
console.log(chalk_1.default.yellow("==============Started Now=================="));
class MM {
    constructor() {
    ...
    login({ username, password }, callback = '') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var query = query_string_1.default.parseUrl(authUrl).query;
            var bodyFormData = {
            ...
            var formData = query_string_1.default.stringify(Object.assign(query, bodyFormData));
            /**
             * Logging in
             */
            try {
    ...
    getCourse(courseId, data = '', callback = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const $ = cheerio_1.default.load(htmlResponse.data, {
    ...
    getBookmarks(options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const $ = cheerio_1.default.load(bookmarks.data, {
                decodeEntities: false
            });
            return {
    ...
    getPaginationInfo(selector, $) {
        ...
        if (paginationEl.hasClass('disabled')) {
            ...
            let pageNumber = query_string_1.default.parseUrl(url).query.page;
            data = {
                'url': url,
